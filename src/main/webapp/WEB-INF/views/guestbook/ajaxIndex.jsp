...
.modal {
	...
	background-color: rgba(0, 0, 0, 0.4); /*순서대로 r,g,b,투명도
											배경이 검은색에 반투명*/
} /*모달창 내용 흰색부분*/
.modal .modal-content {
	width: 400px;
	margin: 0px auto; /*상하 100px, 좌우 가운데*/
	padding: 0px 20px 20px 20px; /*안쪽여백*/
	background-color: #ffffff; /*배경색 흰색*/
	border: 1px solid #888888; /*테투리 모양*/
}
/*닫기버튼*/
				...
				<div id="guestbook">
					...
					<div id="myModal" class="modal">
						<div id="guestbook" class="modal-content">
							...
							<div class="m-body">
								<input class="m-password" type="password" name="password" value=""><br> <input class="m-no" type="text" name="no" value="">
							</div>
...
document.addEventListener("DOMContentLoaded", function(){
	...
	guestbookListArea.addEventListener("click", callMadal);
	...
	btnDelete.addEventListener("click",deleteAddRemove);
...
//모달창에 삭제버튼을 클릭했을때 (진짜삭제)
function deleteAddRemove(event){
		console.log("클릭");
