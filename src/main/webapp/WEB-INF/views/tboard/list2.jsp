	...
	<div id="wrap">
		...
		<div id="container" class="clearfix">
			...
			<div id="content">
				...
				<div id="board">
					<div id="list">
						<form action="${pageContext.request.contextPath}/tboard/list2" method="">
						...
						<div id="paging">
							<ul>
								<c:if test="${pMap.prev}">
									<li><a href="${pageContext.request.contextPath}/tboard/list2?crtPage=${pMap.startPageBtnNo-1}">◀</a></li>
								</c:if>
								
								<c:forEach begin="${pMap.startPageBtnNo}" end="${pMap.endPageBtnNo}" step="1" var="page">
									<c:choose>
										<c:when test="${param.crtPage==page}">
											<li class="active"><a href="${pageContext.request.contextPath}/tboard/list2?crtPage=${page}">${param.crtPage}</a></li>
										</c:when>
										<c:otherwise>
