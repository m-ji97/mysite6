				...
				<div id="board">
					<div id="list">
						...
						<div id="paging">
							<ul>
								<c:if test="${pMap.prev}">
									<li><a href="${pageContext.request.contextPath}/tboard/list3?crtPage=${pMap.startPageBtnNo-1}&keyword=${param.keyword}">◀</a></li>
								</c:if>
								
								<c:forEach begin="${pMap.startPageBtnNo}" end="${pMap.endPageBtnNo}" step="1" var="page">
									<c:choose>
										<c:when test="${param.crtPage==page}">
											<li class="active"><a href="${pageContext.request.contextPath}/tboard/list3?crtPage=${page}&keyword=${param.keyword}">${param.crtPage}</a></li>
										</c:when>
										<c:otherwise>
								...
								<c:if test="${pMap.next}">
									<li><a href="${pageContext.request.contextPath}/tboard/list3?crtPage=${pMap.endPageBtnNo+1}">▶</a></li>
								</c:if>
							</ul>
