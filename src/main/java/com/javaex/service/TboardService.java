...
public class TboardService {
	...
	public Map<String, Object> exeList2(int crtPage){
		...
		*/
		...
		//4 5 =>   (4/5)*5-> 0.8(1)*5-> 5
		//5 5 =>   (5/5)*5-> 1.0(1)*5-> 5
		//6 5 =>   (6/5)*5-> 1.2(2)*5-> 10
		//7 5 =>   (7/5)*5-> 1.4(2)*5-> 10
		//11 5=>  (11/5)*5-> 2.4(3)*5-> 15
		
		int endPageBtnNo = (int)Math.ceil(crtPage/(double)pagBtnCount)*pagBtnCount;
		
		//시작 버튼 번호
		int startPageBtnNo = (endPageBtnNo-pagBtnCount) +1;
